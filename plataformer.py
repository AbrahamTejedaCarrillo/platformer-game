...
#definir tfuente
font = pygame.font.SysFont('arial 93', 90)
...
class Player():
    ...
    def update(self, game_over):
        ...
        #teclas para usar
            ...
            if key[pygame.K_RIGHT]:
                ...
                self.counter += 1
                self.direction = 1
            if key[pygame.K_LEFT] == False and key[pygame.K_UP] == False and key[pygame.K_RIGHT] == False:
                self.counter = 0
                self.index = 0
                if self.direction == 1:
            ...
            #revisar si choca con los enemigos
            if pygame.sprite.spritecollide(self, blob_group, False):
                game_over = -1
                game_over_fx.play()
            
            #revisar si cae en la lava
            if pygame.sprite.spritecollide(self, lava_group, False):
                game_over = -1
                game_over_fx.play()

            #revisar colision con la salida
    ...
    def reset(self, x, y):
        ...
        for num in range(1,12):
            img_right = pygame.image.load(f'img/p{num}.png')
        ...
        self.hitbox = self.rect.inflate(-7, -5)
...
#crear moneda que se muestre en pantalla para contr el score
...
#crear boton
restart_button = Button(screen_width // 2 -70 , screen_height //2 -50, restart_img)
...
while run:
    ...
    if main_menu == True:
        ...
        if game_over == 0:
            ...
            #revisar si se recolecto una moneda
            if pygame.sprite.spritecollide(player, coin_group, True):
                score += 1
                coin_fx.play()
            draw_text('X ' + str(score), font_score, white, tile_size - 7, 10)
        ...
        #si completo el nivel
        if game_over == 1:
            #resetear juego e ir al siguiente nivel
            level += 1
            if level <= max_levels:
                #reset level
                world_data = []
    ...
    #refrescar pantalla continuamente
